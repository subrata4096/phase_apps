...
int phase_manish;
int frame_manish;
int total_frames_manish;
int total_phases_manish;
...
static int ff_filter_frame_framed(AVFilterLink *link, AVFrame *frame)
{
    ...
    total_frames_manish = atoi(getenv("TOTAL_FRAMES_MANISH"));
    total_phases_manish = atoi(getenv("TOTAL_PHASES_MANISH"));
    frame_manish = link->frame_count;
