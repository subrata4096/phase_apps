...
#define FFMPEG_CONFIGURATION "--disable-optimizations --disable-stripping --disable-mmx --disable-mmxext --disable-ssse3 --enable-debug=3 --extra-cflags='-O0 -fno-inline' --enable-gpl --prefix=./build"
